...
export type InstantTransferCreationResult =
...
export type InstantTransferReturnResult =
  ...
  | { ok: true; requiresApproval: true; approval: ApprovalRequest; replayed: boolean; deduplicated: boolean };
export type DebitRequestRespondResult =
  | { ok: true; requiresApproval?: false; debit: InstantTransfer; replayed: boolean }
  | { ok: true; requiresApproval: true; approval: ApprovalRequest; replayed: boolean; deduplicated: boolean };
...
export type PaymentLinkPayResult =
  ...
  | { ok: true; requiresApproval: true; approval: ApprovalRequest; replayed: boolean; deduplicated: boolean };
export type CollectionTillCreditResult =
  | { ok: true; requiresApproval?: false; till: CollectionTill; transfer: InstantTransfer; replayed: boolean }
  | { ok: true; requiresApproval: true; approval: ApprovalRequest; replayed: boolean; deduplicated: boolean };
...
export type EcheqDepositResult =
  | { ok: true; requiresApproval?: false; echeq: Echeq; replayed: boolean }
  | { ok: true; requiresApproval: true; approval: ApprovalRequest; replayed: boolean; deduplicated: boolean };
...
export type RecurringPaymentMandateCreationResult =
  ...
  | { ok: true; requiresApproval: true; approval: ApprovalRequest; replayed: boolean; deduplicated: boolean };
export type RecurringPaymentMandateStatusResult =
  | { ok: true; requiresApproval?: false; mandate: RecurringPaymentMandate; replayed: boolean }
  | { ok: true; requiresApproval: true; approval: ApprovalRequest; replayed: boolean; deduplicated: boolean };
