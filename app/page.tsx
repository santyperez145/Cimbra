    ...
    <main>
      ...
      <section id="plataforma" className="platform-section">
        ...
        <div className="module-grid">
          ...
          <article className="module-card"><span className="module-number">05 · RISK DISPONIBLE</span><div className="module-icon">✓</div><h3>Risk & Reconciliation</h3><p>Reglas, score explicable, casos, holds y conciliación de lotes; KYC/AML externo permanece fuera del sandbox.</p><ul><li>Rules engine y velocity</li><li>Casos y decisiones auditables</li><li>Excepciones de conciliación</li></ul><a href="/console">Abrir operaciones →</a></article>
