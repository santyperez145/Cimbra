    ...
    <main>
      <section className="hero-shell">
        ...
        <div className="proof-strip" aria-label="Controles comprobables de la plataforma">
          ...
          <article><small>01 · CONTRATO</small><b>193 operaciones</b><span>OpenAPI público, SDK tipado y scopes por recurso.</span></article>
      ...
      <section id="developers" className="developer-section">
        ...
        <div className="developer-copy"><p className="eyebrow"><span /> DEVELOPER FIRST, DE VERDAD</p><h2>Una API verificable desde el primer request.</h2><p>Contrato OpenAPI con 193 operaciones, SDK tipado descargable, recursos persistentes, scopes por credencial, request IDs e idempotencia obligatoria en movimientos financieros.</p><div className="developer-stats"><div><strong>193</strong><span>operaciones OpenAPI</span></div><div><strong>PostgreSQL</strong><span>fuente de verdad</span></div><div><strong>Reversas</strong><span>sin mutar postings</span></div></div><a className="button button-coral" href="/developers">Abrir documentación <span>↗</span></a></div>
      </section>
