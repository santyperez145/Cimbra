export const WEBHOOK_EVENT_TYPES = [
  ...
  'book_transfer.cancelled',
  'book_transfer.reversed',
  'wallet.program_created',
  'wallet.created',
  'wallet.frozen',
  'wallet.unfrozen',
  'wallet.closed',
  ...
  'instant.transfer_cancelled',
  'instant.debit_requested',
  'instant.debit_accepted',
  'instant.debit_rejected',
  'instant.qr_created',
  'instant.qr_paid',
  'instant.qr_cancelled',
  'instant.sale_order_created',
  'instant.sale_order_paid',
  'instant.sale_order_cancelled',
  'instant.sale_order_superseded',
  'instant.debt_created',
  'instant.debt_paid',
  'instant.debt_cancelled',
  'collection.link_created',
  'collection.link_cancelled',
  'collection.link_paid',
  'collection.link_credited',
