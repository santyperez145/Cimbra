...
export const SERVICE_CATALOG: readonly ServiceDefinition[] = [
  ...
  },
  {
    ...
    runtime: 'in_process',
    ownedTables: ['organizations', 'platform_operators', 'leads'],
    modules: ['db/organization.ts', 'app/api/demo/route.ts'],
  ...
  },
  {
    ...
    mission: 'Catálogo de rieles y estado de las conexiones oficiales con bancos, cámaras y autoridades.',
    runtime: 'in_process',
    ownedTables: ['platform_rails', 'official_rail_connections'],
    modules: ['db/platform-rails.ts'],
    apiSurfaces: ['app/api/v1/rail-directory'],
    publishes: [],
