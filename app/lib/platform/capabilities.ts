...
export const PLATFORM_CAPABILITIES: readonly PlatformCapability[] = [
  ...
  },
  {
    ...
    summary: 'Links de cobro sandbox, asociación a deuda QR o till CVU, puntos de recaudación con CVU propio, eco cerrado, inbound ledger y devoluciones compensatorias.',
    features: ['payment links', 'link associated with QR debt', 'link associated with collection till', 'collection tills', 'sandbox CVU per till', 'internal collect', 'sandbox inbound cash-in', 'compensating refunds'],
