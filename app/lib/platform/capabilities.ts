...
export const PLATFORM_CAPABILITIES: readonly PlatformCapability[] = [
  ...
  },
  {
    ...
    features: ['sandbox CVU issuance', 'tenant aliases', 'assign/change alias', 'revoke CVU', 'holder confirmation', 'credit push', 'internal debit requests', 'Cimbra QR', 'compensating returns'],
