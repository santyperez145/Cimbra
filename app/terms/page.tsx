...
export default function TermsPage() {
  return <main className="legal-shell">
    ...
    <article>
      ...
      <section><h2>1. Alcance</h2><p>Cimbra ofrece actualmente un entorno tecnológico de prueba para evaluar identidad, recursos financieros sandbox, ledger, transferencias simuladas, tarjetas de prueba y evidencia documental. El servicio no abre cuentas bancarias, no emite tarjetas en redes reales, no presta dinero y no mueve fondos.</p></section>
