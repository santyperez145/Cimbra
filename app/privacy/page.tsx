...
export default function PrivacyPage() {
  return <main className="legal-shell">
    ...
    <article>
      ...
      <section><h2>1. Datos que tratamos</h2><p>Al crear una cuenta guardamos nombre, email, usuario, hash y salt de contraseña, sesiones hasheadas e identidad OAuth cuando la configurás. En el sandbox también almacenamos organización, customers, últimos cuatro dígitos del identificador fiscal, cuentas y tarjetas de prueba, transacciones, journals, holds, auditoría y metadata de documentos. Los archivos de compliance se guardan en almacenamiento privado.</p></section>
      <section><h2>2. Finalidades</h2><p>Usamos estos datos para autenticarte, operar y asegurar el sandbox, mantener trazabilidad, responder solicitudes comerciales, prevenir abuso y diagnosticar fallas. No usamos datos del sandbox para mover fondos ni tomar decisiones crediticias reales.</p></section>
      <section><h2>3. Proveedores</h2><p>La plataforma usa Vercel para ejecución y almacenamiento privado y PostgreSQL administrado para persistencia. Estos proveedores procesan datos sólo para prestar la infraestructura contratada y bajo sus controles de seguridad aplicables.</p></section>
      <section><h2>4. Seguridad</h2><p>Las contraseñas no se almacenan en texto plano. Usamos PBKDF2-HMAC-SHA-256, sesiones opacas revocables, cookies HttpOnly, control de origen, aislamiento por organización, almacenamiento privado y auditoría. Ningún sistema elimina por completo el riesgo, por lo que no debés cargar información financiera real innecesaria.</p></section>
