...
export default function PrivacyPage() {
  return <main className="legal-shell">
    ...
    <article>
      ...
      <section><h2>1. Datos que tratamos</h2><p>Al crear una cuenta guardamos nombre, email, usuario, hash y salt de contraseña, sesiones y tokens de acción hasheados, secreto MFA cifrado, recovery codes hasheados e identidad OAuth cuando la configurás. En el sandbox también almacenamos organización, miembros, roles e invitaciones con vencimiento, customers, últimos cuatro dígitos del identificador fiscal, expedientes KYC/KYB, nombres y últimos cuatro dígitos de partes relacionadas, participación declarada, condición PEP declarada, checks, fuentes, resultados y evidencia, catálogos de servicios, obligaciones, referencias de suscriptor o destino convertidas a digest tenant-scoped con sólo sus últimos cuatro caracteres visibles, consentimientos y agendas de mandatos, órdenes de pago y recarga, cuentas y tarjetas de prueba, transacciones, journals, holds, reglas y decisiones de riesgo, latencia de decisión, challenges step-up con credencial cifrada/hasheada e intentos sin el código en claro, casos, partidas y excepciones de conciliación, checksum y nombre de importaciones, ciclos de settlement, políticas y solicitudes de aprobación, identidad de maker/checker, motivos, vencimientos, auditoría y metadata de documentos. Los CSV de conciliación se descartan tras normalizarlos; los archivos de compliance se guardan en almacenamiento privado.</p></section>
      <section><h2>2. Finalidades</h2><p>Usamos estos datos para autenticarte, administrar el acceso por organización y rol, operar y asegurar el sandbox, mantener trazabilidad, responder solicitudes comerciales, prevenir abuso y diagnosticar fallas. No usamos datos del sandbox para mover fondos ni tomar decisiones crediticias o regulatorias reales; un resultado KYC/KYB del sandbox no equivale a una verificación oficial.</p></section>
