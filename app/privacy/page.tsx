...
export default function PrivacyPage() {
  return <main className="legal-shell">
    ...
    <article>
      ...
      <section><h2>4. Seguridad</h2><p>Las contraseñas no se almacenan en texto plano. Usamos PBKDF2-HMAC-SHA-256, sesiones opacas revocables, cookies HttpOnly, MFA TOTP opcional, secretos cifrados, control de origen, aislamiento por organización, almacenamiento privado y auditoría. Ningún sistema elimina por completo el riesgo, por lo que no debés cargar información financiera real innecesaria.</p></section>
