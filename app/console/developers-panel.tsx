...
export default function DevelopersPanel({ journalCount }: { journalCount: number }) {
  ...
  return <div className="module-view developer-console">
    <div className="module-view-head"><div><p>PLATFORM INTEGRATION</p><h1>API y webhooks</h1><span>Credenciales S2S con scopes y eventos firmados, persistidos y reintentables.</span></div><span className="module-health"><i /> v2026-08-29</span></div>
