...
const resources = [
  ...
  ['POST', '/api/v1/transfers', 'Crear una transferencia idempotente'],
...
export default function DevelopersPage() {
  return (
    <main className="docs-shell">
      ...
      <aside className="docs-sidebar"><nav><strong>COMENZAR</strong><a className="active" href="#quickstart">Introducción</a><a href="#auth">Autenticación</a><a href="#api-keys">API keys</a><a href="#webhooks">Webhooks</a><strong>RECURSOS IMPLEMENTADOS</strong><a href="#resources">Customers</a><a href="#resources">Accounts</a><a href="#resources">Transfers</a><a href="#resources">Ledger y holds</a><a href="#resources">Risk y casos</a><a href="#resources">Reconciliation</a><a href="#resources">Cards</a><a href="#resources">Compliance</a><a href="#idempotency">Idempotencia</a></nav><div className="docs-version">API VERSION <b>2026-08-28</b></div></aside>
