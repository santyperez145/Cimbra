...
ALTER TABLE "approval_requests" ADD CONSTRAINT "approval_requests_action_resource" CHECK ((
  ...
  ("action_type" = 'collection.pay' AND "resource_type" = 'payment_link') OR
  ("action_type" = 'collection.till_credit' AND "resource_type" = 'collection_till') OR
  ...
  ("action_type" = 'recurring_mandate.resume' AND "resource_type" = 'recurring_payment_mandate') OR
  ("action_type" = 'debit_request.accept' AND "resource_type" = 'instant_transfer') OR
  ("action_type" = 'payment_qr.pay' AND "resource_type" = 'payment_qr') OR
  ("action_type" = 'echeq.deposit' AND "resource_type" = 'echeq') OR
  ("action_type" = 'hold.capture' AND "resource_type" = 'hold') OR
  ("action_type" = 'hold.release' AND "resource_type" = 'hold') OR
