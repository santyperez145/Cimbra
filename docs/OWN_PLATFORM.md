...
| Risk & Fraud | reglas, velocity, scoring, casos y listas | API, eventos, consola | Base técnica |
| Reconciliation | tres vías, settlement, excepciones y archivos | API, webhooks, archivos, consola | Base técnica |
