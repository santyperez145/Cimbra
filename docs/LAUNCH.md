...
- portal developer conectado al OpenAPI real, con las 194 operaciones, parámetros, respuestas, búsqueda, quickstart ejecutable, límites del entorno sandbox y changelog;
