...
- pagos instantáneos sandbox con CVU/alias (asignar o cambiar sobre un CVU existente, un cambio real cada 24 h; eliminar el CVU no toca cuenta ni saldo), confirmación de titular, crédito interno o cash-out, débito interno, QR Cimbra dinámico y estático y returns compensatorios;
