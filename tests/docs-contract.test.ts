...
test('el OpenAPI público usa el sandbox real y operaciones identificables', () => {
  ...
  assert.equal(operations.length, 194);
...
test('OpenAPI publica book transfers y statements como contratos completos', () => {
  ...
  assert.equal(spec.paths['/api/v1/recurring-mandates/{id}/executions'].get.operationId, 'listRecurringPaymentMandateExecutions');
  ...
  assert.equal(spec.paths['/api/v1/qr-debts'].get.operationId, 'listQrDebts');
  assert.equal(spec.paths['/api/v1/qr-debts'].post.operationId, 'createQrDebt');
  assert.equal(spec.paths['/api/v1/qr-debts/{id}'].get.operationId, 'retrieveQrDebt');
  assert.equal(spec.paths['/api/v1/qr-debts/{id}'].delete.operationId, 'cancelQrDebt');
  ...
  assert.equal(spec.paths['/api/v1/collection-tills'].get.operationId, 'listCollectionTills');
  assert.equal(spec.paths['/api/v1/collection-tills'].post.operationId, 'createCollectionTill');
  assert.equal(spec.paths['/api/v1/collection-tills/{id}'].get.operationId, 'retrieveCollectionTill');
  assert.equal(spec.paths['/api/v1/collection-tills/{id}'].delete.operationId, 'disableCollectionTill');
  assert.equal(spec.paths['/api/v1/collection-tills/{id}/alias'].patch.operationId, 'assignCollectionTillAlias');
  assert.equal(spec.paths['/api/v1/collection-tills/{id}/inbound'].post.operationId, 'creditCollectionTill');
